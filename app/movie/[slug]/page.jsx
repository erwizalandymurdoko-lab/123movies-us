...
export async function generateMetadata({ params }) {
  ...
  if (CATEGORIES.includes(slug)) {
    ...
    return {
      title: `123Movies US - ${title} Movies`,
      description: `Explore the ${title} movies collection on 123Movies US.`,
    };
  }
  ...
  if (genreMatch) {
    ...
    return {
      title: `123Movies US - ${genreName} Movies`,
      description: `Discover ${genreName} movies on 123Movies US.`,
    };
  }
  ...
  return {
    title: `123Movies US - ${movieData.title}`,
